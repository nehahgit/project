...
public class view_institution extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://" + hu + ":8000/myapp/and_view_insti/";
...
//                                        gv.setAdapter(new Custom_view_visited_game(getApplicationContext(),name,gamecode));
                                 lv.setAdapter(new custom_view_institution(getApplicationContext(),id,manager,name,email,city,district,pin,phone,image,status,LOGIN_id,website));
                            }
