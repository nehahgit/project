...
public class view_shop_review extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://" + hu + ":8000/myapp/and_view_shop_review/";
...
//                                        gv.setAdapter(new Custom_view_visited_game(getApplicationContext(),name,gamecode));
                                lv.setAdapter(new custom_view_shop_review(getApplicationContext(),id,review,SHOP_id,USER_id,date));
                            }
