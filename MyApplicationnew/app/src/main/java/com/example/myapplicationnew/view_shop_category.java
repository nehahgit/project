...
public class view_shop_category extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_shop_category);
        lv=findViewById(R.id.cat);
...
//                                rating=new String[js1.length()];
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    category_name[i]=u.getString("cname");
//                                    SHOP_id[i]=u.getString("insti_name");
...
//                                        gv.setAdapter(new Custom_view_visited_game(getApplicationContext(),name,gamecode));
                                lv.setAdapter(new custom_view_category(getApplicationContext(),id,category_name));
                            }
